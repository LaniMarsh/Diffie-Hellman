# initialize parameters for changeing a to q - 1
...
# mallory knows the shared key is derrived from 1 or q-1 from the manipulation of a
print("Mallory computes the shared key:")
sharedKeyM = deriveKey(q, a, a)
